...
export default function TablePermission({ permissions, withHeader = true, filters }: TablePermissionProps) {
        ...
        <>
            {withHeader && (
                <div className="flex justify-between gap-2">
                    ...
                    {can.create_role && <ButtonAdd tabIndex={3} route={route('permissions.create')} />}
                </div>
            )}
